...
const clientRepository = new ClientRepository(AppDataSource);

ipcMain.handle("add/client", async (event, name: string, surname: string, phone: string, alias?: string) => {
  return await clientRepository.addClient(name, surname, phone, alias);
});

ipcMain.handle("get/client", async (event, name?: string, surname?: string, phone?: string, alias?: string) => {
  return await clientRepository.getClient(name, surname, phone, alias);
});

ipcMain.handle("get/all", async (event, args) => {
